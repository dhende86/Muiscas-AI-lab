...
/**
 * Main Application Component wrapper for Muiscas AI Lab Website
 *
 * Provides the core layout structure and animated background for the primary sections
 * such as the Hero, Topics, and Paths.
 *
 * @returns {JSX.Element} The rendered React Application layout.
 */
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden bg-[#050b1f]">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div
          className="absolute top-[-5%] right-[10%] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-blue-600/25 to-cyan-400/15 blur-[130px] animate-pulse"
        />
        <div
